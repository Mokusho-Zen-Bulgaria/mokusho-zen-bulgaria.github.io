...
Сешшинът е период на интензивна дзен практика, в който времето и мислите изчезват, заменени от съсредоточаване във всичко, което правим: седящата и ходещата немедитации\*, почистването, готвенето, храненето, чуването, виждането, тишината. Сешшинът е приложно изкуство да останеш насаме с най-съкровеното, без да се откъсваш от другите хора. За това ни помага подредената програма: ставаме в 5:30, практикуваме дзадзен четири пъти по час и половина до 21 чака, а през другото време  има Дарма лекции, време за въпроси и отговори, работа, хранене.

Водещият Кошин роши е румънски учител от приемствената линия на Тайсен Дешимару, който е пренесъл автентичния дзен от Япония в Европа преди 50 години. Във всекидневния си живот той е университетски преподавател по архитектура.

Необходимо е да си носите:
* Широки, удобни тъмни дрехи
* Три малки купички, които влизат една в друга и лъжица
* Спален чувал или одеало (и шалте). В дожото има 16 матрака, на които ще спим. 

Мястото на провеждането е къща на края село Кътина. Може да дойдете с автобус 27 от метростанция „Княгиня Мария Луиза“ и после към 15 пеша. Моля, не използвайте Google Maps, защото ще ви нахендри в нищото, а вижте подробните указания на [сайта на нашата домакиня](https://deviflow.com/domat-na-devi/).
...
Не е нужно да сте ваксинирани против ковид или да се тествате.

За да се запишете, моля, попълнете [тази кратка форма](https://deviflow.com/domat-na-devi/) до 9. март. Ще започнем в петък, 10.03, от 17ч и ще завършим в неделя по обед.
